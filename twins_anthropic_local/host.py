"""Local host entry point for the Anthropic twin.
...
def create_local_app():
    ...
    WSGI entry point::
        ...
        gunicorn 'twins_anthropic_local.host:create_local_app()'
    """
    ...
    logger.info(
        "Local anthropic twin ready — db=%s base_url=%s", DB_PATH, BASE_URL
    )
    return app
...
def main():
    ...
    logger.info("Starting local anthropic twin on %s:%d", HOST, PORT)
